...
public class ConexaoMysql {
    ...
    public ConexaoMysql() {
    	// String de conexao
    	this.url = "jdbc:mysql://127.0.0.1:3306/unaerp?useSSL=false&allowPublicKeyRetrieval=true&useTimezone=true&serverTimezone=UTC";
        this.usuario = "minicurso";   // Informe o usuario e senha
        this.senha = "123456"; // do seu banco de dados
